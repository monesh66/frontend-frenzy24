      ...
      <div className='navbar'>
          <nav>
              <ul>
                ...
                <li className='nav-link nav-link-ltr' ><a href="">Counseling</a></li>
                ...
                <li className='nav-link nav-link-ltr' ><a href="">Food</a></li>
                <li className='nav-link nav-link-ltr' ><a href="">About Us</a></li>
